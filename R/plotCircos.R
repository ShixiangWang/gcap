gcap.plotCircos <- function(fCNA,
  ...
  if (!is.null(highlight_genes)) {
    ...
    circlize::circos.genomicLabels(bed,
      labels = bed$gene_id, side = "outside", cex = 0.5,
  ...
  circlize::circos.genomicTrack(
    ...
    panel.fun = function(region, value, ...) {
      circlize::circos.genomicLines(region, value, numeric.column = 1,
  ...
  circlize::circos.genomicTrack(bed_cn,
